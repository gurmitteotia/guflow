### Guflow
A C#.NET library, built on [Amazon SWF](https://aws.amazon.com/swf/) ( Simple Workflow Service ), to let you coordinate the execution of serverless AWS Lambda functions and activities with ease.
