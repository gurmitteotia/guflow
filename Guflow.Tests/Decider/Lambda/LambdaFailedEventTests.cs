...
namespace Guflow.Tests.Decider
{
    ...
    public class LambdaFailedEventTests
    {
        ...
        public void Setup()
        {
            ...
            var eventGraph = _builder.LambdaFailedEventGraph(Identity.Lambda("lambda_name").ScheduleId(), "input", "reason", "details");
        ...
        {
            var eventGraph = _builder.LambdaFailedEventGraph(Identity.Lambda("differnt_name").ScheduleId(), "input", "reason", "details");
