...
namespace Guflow.Tests.Decider
{
    ...
    public class ActivityItemExtensionTests
    {
        ...
        public void Result_can_return_complex_activity_result_as_dynamic_type()
        {
            ...
            _activityItem.SetupGet(a => a.LatestEvent).Returns(CompletedEvent(result));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(FailedEvent("r","d"));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(CompletedEvent("1"));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(CompletedEvent(""));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(StartedEvent());
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(CompletedEvent("r"));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(CancelledEvent("d"));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(TimedoutEvent("d", "d1"));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(FailedEvent("reason", "details"));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(CompletedEvent("res"));
            var lastFailedEvent = _activityItem.Object.LastFailedEvent();
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(TimedoutEvent("reason", "details"));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(CancelledEvent("details"));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(CompletedEvent("details"));
        ...
        {
            _activityItem.SetupGet(a => a.LatestEvent).Returns(CancelledEvent("res"));
            var lastCompletedEvent = _activityItem.Object.LastCompletedEvent();
