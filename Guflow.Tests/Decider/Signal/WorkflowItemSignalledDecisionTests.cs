...
namespace Guflow.Tests.Decider
{
    ...
    public class WorkflowItemSignalledDecisionTests
    {
        ...
        public void Equality()
        {
            ...
            Assert.IsTrue(new WorkflowItemSignalledDecision(id, 1, "s").Equals(new WorkflowItemSignalledDecision(id, 1, "s")));
            Assert.IsTrue(new WorkflowItemSignalledDecision(id, 1, "s").Equals(new WorkflowItemSignalledDecision(id, 1, "S")));
        ...
        {
            var id = Identity.Lambda("a").ScheduleId();
            var decision = new WorkflowItemSignalledDecision(id, 10, "Signal");
